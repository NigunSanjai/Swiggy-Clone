...
const DashHeader = () => {
  ...
  const resturantdetails = useSelector((state) => state.resturants.value);
  const filterresturantdetails = resturantdetails.slice(1);
  ...
  const [results, setresults] = useState([
    { id: '', name: '', locality: '', rating: '' },
  ]);

  function handleSearch(search) {
    if (search.length == 1) {
      setclick(true);
      setresults([{ id: '', name: '', locality: '', rating: '' }]);
    }
    if (search.length > 1) {
      setclick(false);
      const match = filterresturantdetails.filter((res) =>
        String(res.name).toLowerCase().includes(search.toLowerCase()),
      );
      setresults(match);
    } else {
      const match = [{ id: '', name: '', locality: '', rating: '' }];
      setresults(match);
    }
  }
  ...
  return (
    <header className="_76q0O snipcss-2IWIL">
          ...
          <div className="_2z2N5">
            <div>
              <span className="_1tcx6">
                <span className="_3odgy">{loc.name} &nbsp;</span>
              </span>

              <span className="_3HusE">{loc.place_formatted}&nbsp; </span>
            </div>
          </div>
          <ul className="_1JNGZ">
            <li className="_1fo6c">
            ...
            <li className="_1fo6c">
              <div className="_2CgXb">
                ...
                <span>{user.name ? user.name : 'Sign In'}</span>
              </div>
            </li>
                ...
                <a className="_1T-E4">
                  ...
                  {search ? (
                    <div>
                      <input
                        type="text"
                        placeholder="Search for Popular Resturants"
                        style={{
                          width: '500px',
                          borderRadius: '10px',
                          padding: '10px',
